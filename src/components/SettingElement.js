...
const SettingElement = (props) => {
    ...
    return (
        <View style={{alignItems: 'center'}}>
            <View style={{width: 320, borderColor: 'rgba(0, 0, 0, 0.5)', borderBottomWidth: 1, flexDirection: 'row', marginVertical: 10}}>
                <Text style={{width: 290, color: '#000', fontSize: 24, fontWeight: '700', fontFamily: 'Inria Serif'}}>{name}</Text>
                <Icon name={'angle-right'} style={{ fontSize: 20, padding: 10}}></Icon>
            </View>
        </View>
    )
}
